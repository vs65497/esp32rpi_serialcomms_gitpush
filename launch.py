...
p = subprocess.Popen('scp '+ archive_path +' base@192.168.1.101:/home/base/esp32rpi_serialcomms_gitpush/data', shell=True)
sts = p.wait()
p = subprocess.Popen('scp '+ latest_path +' base@192.168.1.101:/home/base/esp32rpi_serialcomms_gitpush/data', shell=True)
sts = p.wait()
